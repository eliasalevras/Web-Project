...
if (isset($_SESSION['role']) && $_SESSION['role'] === "professor") {
    ...
    if ($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['cancel_thesis'])) {
        ...
        //An perasoun 2 eti apo tin imerominia anathesis (to do)
        ...
        if ($row) {
            ...
            if ($affected > 0) {
                ...
                $message = '<div class="alert alert-success text-center"> Η κατάσταση της διπλωματικής έχει οριστεί σε ακύρωση.</div>';
                // echo "Thesis status set to cancel.";
            } else {
                $message = '<div class="alert alert-success text-center">Δεν βρέθηκε ενεργή διπλωματική για τον φοιτητή AM: .  $student_am. </div>.';
...
<head>
    ...
    <title>Ακύρωση Ενεργής Διπλωματικής Εργασίας</title>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <div class="card shadow-lg p-4">
        <h2 class="mb-4 text-center text-primary">Ακύρωση Ενεργής Διπλωματικής Εργασίας</h2>
    ...
    ?>
        ...
        <form method="POST" action="professor_cancel_thesis.php" enctype="multipart/form-data">
