...
<head>
    ...
    <title>Δημιουργία Ανακοίνωσης Παρουσίασης Δηπλωματικής.</title>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <div class="card shadow-lg p-4">
        <h2 class="mb-4 text-center text-primary">Δημιουργία Ανακοίνωσης Παρουσίασης Δηπλωματικής</h2>
        ...
        <form method="POST" action="announcements.php" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="student_am" class="form-label fw-bold">Εισαγωγή αριθμού φοιτητή για δημιουργία ανακοίνωσης διπλωματικής εργασίας:</label>
            ...
            <div class="d-grid mt-4">
                <button type="submit" id="announcement" name="announcement" class="btn btn-primary btn-lg">
                    Δημιουργία Ανακοίνωσης Παρουσίασης Δηπλωματικής
                </button>
            </div>
        </form>
    </div>
